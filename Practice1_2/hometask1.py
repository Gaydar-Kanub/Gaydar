...
st = "отличная строка"
for i in st:        # здесь какой-то фор
    print(i)        # здесь какой-то принт
...
for i in range(7, 24):  # здесь фор и range
    print(i)            # здесь print
...
for i in range(100, 0, -10):    # здесь фор и range
    print(i)                    # здесь print
...
for i in range(44):     # здесь фор и range
    print(i)            # здесь print
...
for i in range(1, 36, 2):       # здесь фор и range
    print(i)                    # здесь print
